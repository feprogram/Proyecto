...
function AgregarProducto() {
  ...
  const agregarProducto = async (producto) => {
    try {
      ...
      const respuesta = await fetch(
        "https://68d9c26590a75154f0db169b.mockapi.io/Api/productos",
        {
          method: "POST",
  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      ...
      const agregarOtroProducto = window.confirm('Producto agregado correctamente!\n\n¿Desea agregar otro producto?\n\n "Aceptar": Agrega otro producto\n "Cancelar": Redirige a la lista productos');

      if (agregarOtroProducto){
        //Con este código limpio el formulario para agregar un nuevo producto.
        setProducto({
        nombre: "",
        precio: "",
        descripcion: "",
  ...
  return (
    <form
      ...
      style={{ maxWidth: "600px", margin: "0 auto", padding: "20px", textAlign: "left", marginTop: "2rem" }}
    >
