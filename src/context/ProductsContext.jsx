...
//El provider es fundamental. Provee el contexto a todo lo que esté incluido de App.jsx 
// y que vayan a compartir esta información
...
export const ProductsProvider = ({ children }) => {
  ...
  const editarProducto = async (productoActualizado) => {
    try {
      const respuesta = await fetch(`https://68d9c26590a75154f0db169b.mockapi.io/Api/productos/${productoActualizado.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
